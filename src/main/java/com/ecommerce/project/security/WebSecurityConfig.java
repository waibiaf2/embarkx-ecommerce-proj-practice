...
public class WebSecurityConfig {
    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            if (!userRepository.existsByUserName("hajara")) {
                User admin = new User(
                    "hajara",
                    "hajara@example.com",
                    passwordEncoder.encode("password1")
            ...
            //Updating the roles for existing users
            ...
            userRepository.findByUserName("hajara").ifPresent(user -> {
                user.setRoles(adminRoles);
                userRepository.save(user);
            });
